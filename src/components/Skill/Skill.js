...
const tab = ["Android", "Front-End", "Back-End", "Tool&Other"];
const skills = [
  [
    // android
    {
    ...
    },
    {
      ...
      content: [
        "Jetpack Compose을 이용하여 기초적인 UI를 구성할 수 있습니다.",
    ...
    },
    {
      title: "viewPager2",
      content: [
        "viewPager2를 이용하여 화면을 구성할 수 있습니다.",
        "Adapter를 사용하여 동적으로 view를 생성할 수 있습니다.",
      ],
      img: viewPager2,
    },
    {
      title: "Custom View",
      content: [
        "Custom View를 만들어 xml 파일 또는 다른 코드 내에서 사용할 수 있습니다.",
        "녹음기 어플리케이션을 만들 때 음파 모양을 만들기 위해 사용했었습니다.",
      ],
      img: openMenu,
    },
    {
      ...
      content: [
        "Firebase에 프로젝트를 생성하고 어플리케이션 내에서 사용할 수 있습니다.",
        "Authentication: 구글 로그인, 이메일/비밀번호 로그인 등을 구현할 때 사용하였습니다.",
        "FireStore, Realtime DB: 사용자끼리 공유가 필요한 데이터를 저장하는데 사용하였습니다.",
      ],
      img: firebase,
    },
    {
    ...
    },
    {
      title: "Koin(MVP, MVVM)",
      content: [
        "Service Locator 방식으로 Koin을 사용하여 DI를 구현할 수 있습니다.",
  ...
  [
    ...
    },
    {
      title: "React JS",
      content: [
        "React JS 라이브러리를 사용하여 소규모 웹 페이지를 개발할 수 있습니다.",
