...
import wookwa from '../../../resource/images/woowahan_tech.png';
	...
	const [data, setData] = useState([
		{
			title: '우아한 테크캠프 5기',
			img: wookwa,
			content: '우아한 테크캠프 5기 안드로이드 Part 참여!',
			hover: false,
		},
		{
